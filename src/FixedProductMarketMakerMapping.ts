...
export function handleFundingAdded(event: FPMMFundingAdded): void {
  ...
  fpmm.fpmmFactoryAddress = event.params.fpmmFactoryAddress.toHexString();
  fpmm.PoolBalances = event.params.poolBalances;
  fpmm.save();
...
export function handleBuy(event: FPMMBuy): void {
  ...
  fpmm.totalFpmmHoldingValue = event.params.totalFpmmHoldingValue;
  fpmm.PoolBalances = event.params.poolBalances;
  fpmm.questionId = event.params.questionId.toHexString();
  fpmm.save();
...
export function handlePlaySeason(event: PlaySeason): void {}

export function handlePausedSeason(event: PausedSeason): void {}

export function handleConcludedSeason(event: ConcludedSeason): void {}
