...
export class ConcludedSeason extends ethereum.Event {
  get params(): ConcludedSeason__Params {
    return new ConcludedSeason__Params(this);
  }
}

export class ConcludedSeason__Params {
  _event: ConcludedSeason;

  constructor(event: ConcludedSeason) {
    this._event = event;
  }
...
export class PausedSeason extends ethereum.Event {
  get params(): PausedSeason__Params {
    return new PausedSeason__Params(this);
  }
}

export class PausedSeason__Params {
  _event: PausedSeason;

  constructor(event: PausedSeason) {
    this._event = event;
  }
...
export class PlaySeason extends ethereum.Event {
  get params(): PlaySeason__Params {
    return new PlaySeason__Params(this);
  }
}

export class PlaySeason__Params {
  _event: PlaySeason;

  constructor(event: PlaySeason) {
    this._event = event;
  }
