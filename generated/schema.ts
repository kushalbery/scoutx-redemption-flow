...
export class FixedProductMarketMaker extends Entity {
  constructor(id: string) {
    ...
    this.set("PoolBalances", Value.fromBigIntArray(new Array(0)));
    this.set("fpmmFactoryAddress", Value.fromString(""));
  ...
  get PoolBalances(): Array<BigInt> {
    let value = this.get("PoolBalances");
    return value!.toBigIntArray();
  }

  set PoolBalances(value: Array<BigInt>) {
    this.set("PoolBalances", Value.fromBigIntArray(value));
  }

  get fpmmFactoryAddress(): string {
    let value = this.get("fpmmFactoryAddress");
    return value!.toString();
  }

  set fpmmFactoryAddress(value: string) {
    this.set("fpmmFactoryAddress", Value.fromString(value));
  }
...
export class PlaySeason extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save PlaySeason entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save PlaySeason entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
      store.set("PlaySeason", id.toString(), this);
    }
  }

  static load(id: string): PlaySeason | null {
    return changetype<PlaySeason | null>(store.get("PlaySeason", id));
  }
...
export class PausedSeason extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save PausedSeason entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save PausedSeason entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
      store.set("PausedSeason", id.toString(), this);
    }
  }

  static load(id: string): PausedSeason | null {
    return changetype<PausedSeason | null>(store.get("PausedSeason", id));
  }
...
export class ConcludedSeason extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save ConcludedSeason entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save ConcludedSeason entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
      store.set("ConcludedSeason", id.toString(), this);
    }
  }

  static load(id: string): ConcludedSeason | null {
    return changetype<ConcludedSeason | null>(store.get("ConcludedSeason", id));
  }
